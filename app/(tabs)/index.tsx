  ...
  return (
    ...
    >
      <ThemedView style={styles.titleContainer}>
        <ThemedText type="title">Welcome to HomeHelper!</ThemedText>
        <HelloWave />
      </ThemedView>
      ...
      <ThemedView style={styles.stepContainer}>
        <ThemedText type="subtitle">Step 2: Explore Services</ThemedText>
        <ThemedText>
          Tap the Explore tab to find out more about available services.
        </ThemedText>
      </ThemedView>
      <ThemedView style={styles.stepContainer}>
        <ThemedText type="subtitle">Step 3: Manage Your Bookings</ThemedText>
        <ThemedText>
